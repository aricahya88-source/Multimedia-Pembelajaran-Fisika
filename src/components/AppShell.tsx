...
import {
  ...
  Users, BookOpenCheck, FolderKanban, LogOut, Menu, X, LibraryBig, ScrollText, UserRound, MessagesSquare
} from 'lucide-react';
...
const desktopExtra = [
  ['/projects','Workflow Proyek',FolderKanban],
  ['/guides','Panduan',LibraryBig]
] as const;

export default function AppShell({children,title='MPF'}:{children:React.ReactNode;title?:string}) {
  ...
  return <div className="app-bg">
    ...
    <aside className="desktop-sidebar glass-panel">
      <div className="brand">
        <img className="brand-logo-image" src="/icon-192.png" alt="Logo MPF"/>
        <div><strong>MPF</strong><small>Multimedia Pembelajaran Fisika</small></div>
      </div>
    ...
    <div className="app-stage">
      <header className="topbar glass-panel">
        <div>
          <span className="eyebrow">MULTIMEDIA PEMBELAJARAN FISIKA • OBE</span>
          <h1>{title}</h1>
        </div>
